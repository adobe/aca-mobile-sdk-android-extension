...
> **Note:** All `additionalData` values are converted to strings before being sent to AEP. You can pass any type (String, Int, Double, Boolean, nested objects), but they will be stringified in the XDM payload.
