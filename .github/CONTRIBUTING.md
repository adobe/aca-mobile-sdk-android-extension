...
2. **Clone your fork** locally:
   ```bash
   git clone git@github.com:YOUR_USERNAME/aca-mobile-sdk-android-extension.git
   cd aca-mobile-sdk-android-extension
   ```
3. **Add upstream remote**:
   ```bash
   git remote add upstream git@github.com:adobe/aca-mobile-sdk-android-extension.git
   ```
4. **Sync dependencies**:
   ```bash
...
6. **Open a Pull Request** to `adobe/aca-mobile-sdk-android-extension:main`
...
- Uploads AAR artifact
- Marks as pre-release (for beta/RC)

✅ **Publishes to Maven Central** (for RC and GA only):
- Signs artifacts with GPG
- Publishes to Sonatype OSSRH
- Closes and releases staging repository
...
Week 8: General Availability
  └─ v1.0.0 (automated release + Maven Central)
  └─ Production-ready 🚀
```
...
- Add KDoc documentation comments (`/**`)
...
- **Questions?** Open a [GitHub Discussion](https://github.com/adobe/aca-mobile-sdk-android-extension/discussions)
- **Bug Report?** Open an [Issue](https://github.com/adobe/aca-mobile-sdk-android-extension/issues)
- **Feature Request?** Open an [Issue](https://github.com/adobe/aca-mobile-sdk-android-extension/issues)
...
7. **Verify release** on GitHub and Maven Central (for GA/RC)
